...
Then read the row for `keralavotemap.site`. Or pull from
...
## 2026-05-11 — site scaffolded; growth log started
- **Status:** active
...
- **Action:** project scaffolded via `portfolio new bootstrap`; first deploy
  pending. After deploy: verify in GSC as `sc-domain:keralavotemap.site` and submit
  the sitemap.
- **Result:** TBD — review 2026-06-08
- **Learning:** TBD
